...
**「我每天都有走路啊。」**
走路對心臟有幫助，但走路不是阻力訓練——對骨頭來說，走路的負重不夠大、刺激不夠強，骨密度提升效果有限。散步跟深蹲是兩件不同的事，不能互換。

**「我有吃鈣片了。」**
鈣片建議分次吃比一次吞效果更好（單次劑量太大時吸收效率較差）。同時沒有充足維生素 D 的話，鈣吸收也會打折。

**「健檢骨質正常，表示沒問題。」**
健檢的骨密度報告通常以「T 值」表示：T 值 -1 以上才算正常，-1 到 -2.5 是骨質減少（還沒到骨質疏鬆，但已經在滑坡了）。多少人看到「無明顯異常」就放下心，但沒細看 T 值數字。

**「我還沒停經，不用擔心。」**
停經前幾年（約 40 歲中後期開始），雌激素就已經開始波動下降。這個時間窗口才是介入最有效的時機，等到停經後再開始，效益打折。
